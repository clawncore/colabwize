  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: "What is ColabWize?",
          a: "ColabWize is an academic integrity platform that helps students and researchers defend their work with originality checking, citation auditing, AI detection, and authorship certificates.",
        },
        {
          q: "How does ColabWize work?",
          a: "Upload your document, and we'll scan it for originality, check citation quality, detect AI-generated content, and track your authorship—all in one dashboard.",
        },
        {
          q: "Is my data secure?",
          a: "Yes! We use enterprise-grade encryption, never share your data, and you can delete your documents anytime.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          a: "Yes! We offer a free tier with 3 document scans per month. No credit card required.",
        },
        {
          q: "Can I cancel anytime?",
          a: "Absolutely. Cancel your subscription anytime with no penalties or fees.",
        },
        {
          q: "Do you offer student discounts?",
          a: "Yes! Students get 20% off with a valid .edu email address.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          a: "We support PDF, DOCX, and TXT files up to 100,000 characters.",
        },
        {
          q: "How accurate is the AI detection?",
          a: "We use multiple AI detection APIs (GPTZero, Originality.ai) plus our own heuristics for 95%+ accuracy.",
        },
        {
          q: "Can I download my certificate?",
          a: "Yes! Generate and download professional PDF certificates instantly.",
        },
      ],
    },
  ];
              ...
              <div
                ...
                <div className="space-y-4">
                  {category.questions.map((faq, i) => (
                    <details
                      key={i}
                      className="bg-white border border-gray-300 rounded-lg p-6 group">
