...
const InstallationPage = () => {
  ...
  const steps = [
    {
      title: "Sign Up",
      description: "Create your ColabWize account",
      icon: "1",
    },
    {
      title: "Download",
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="flex-1 mb-4 md:mb-0">
              ...
              <p className="opacity-90">
                ColabWize works on all major platforms with minimal system
                requirements
              </p>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {platforms.map((platform, index) => (
                <div
                  key={index}
                  className="p-4 hover:border-blue-300 hover:bg-blue-50 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-6">
              {requirements.map((req, index) => (
                <div key={index}>
                  <h3 className="text-lg font-semibold mb-3">{req.category}</h3>
              ...
              {steps.map((step, index) => (
                <div key={index} className="flex items-start">
                  <div className="flex-shrink-0 relative">
                    <div className="flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 border-2 border-blue-200 text-blue-800 font-bold text-lg z-10 relative">
                      {step.icon}
                    </div>
                  </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <RefreshCw className="h-5 w-5 text-blue-500 mr-2 mt-0.5 flex-shrink-0" />
