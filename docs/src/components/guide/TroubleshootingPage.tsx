      ...
      issues: [
        ...
        },
        {
          ...
          solutions: [
            ...
            "Add noreply@colabwize.com to your contacts",
      ...
      issues: [
        {
          ...
          description: "Improve the performance of ColabWize",
          solutions: [
      ...
      issues: [
        {
          ...
          solutions: [
            ...
            "Clear your browser cache and cookies",
            "Try using ColabWize in incognito/private mode",
      ...
      issues: [
        {
          ...
          solutions: [
            "Restart your device",
            "Update the ColabWize app to the latest version",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <RefreshCw className="h-5 w-5 text-gray-500 mr-2 mt-0.5 flex-shrink-0" />
                <span className="text-gray-600">
                  Restart the application or browser
                </span>
              </li>
              <li className="flex items-start">
                <Wifi className="h-5 w-5 text-gray-500 mr-2 mt-0.5 flex-shrink-0" />
                <span className="text-gray-600">
                  Check your internet connection
                </span>
              </li>
              <li className="flex items-start">
                <HardDrive className="h-5 w-5 text-gray-500 mr-2 mt-0.5 flex-shrink-0" />
                <span className="text-gray-600">
                  Clear browser cache and cookies
                </span>
              </li>
              <li className="flex items-start">
                <Zap className="h-5 w-5 text-gray-500 mr-2 mt-0.5 flex-shrink-0" />
                <span className="text-gray-600">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                <AlertTriangle className="h-5 w-5 text-gray-500 mr-2 mt-0.5 flex-shrink-0" />
                <span className="text-gray-600">
