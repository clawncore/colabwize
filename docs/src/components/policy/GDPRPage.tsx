      ...
      <div className="container-custom py-8">
        ...
        <div className="p-8 mb-12">
          ...
          <p className="text-gray-600">
            ColabWize is committed to full compliance with the GDPR and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold">Purpose Limitation</h3>
              </div>
              <p className="text-gray-600">
        ...
        <div className="p-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3">Data Transfers</h3>
        ...
        <div className="p-8 mb-12">
          <h2 className="text-2xl font-bold mb-6">Data Protection Officer</h2>
          <p className="text-gray-600 mb-4">
