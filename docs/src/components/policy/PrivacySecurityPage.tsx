...
const PrivacySecurityPage = () => {
  ...
  return (
    <div className="min-h-screen px-8">
      ...
      <div className="p-6">
        <h2 className="text-2xl font-bold mb-4">Privacy & Security Tips</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h3 className="text-lg font-semibold mb-3">Protect Your Account</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-3">Manage Your Privacy</h3>
            <ul className="space-y-2">
              <li className="flex items-start">
                <div className="h-1.5 w-1.5 bg-gray-400 rounded-full mr-3 mt-2"></div>
                <span className="text-gray-600">
