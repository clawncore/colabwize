      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
            Your Data is Safe With Us. We take security seriously. Learn about
            our enterprise-grade security measures, compliance certifications,
            and commitment to protecting your data.
          </p>
...
function FeaturesPresentationFlow() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Third-party penetration testing and security audits every quarter.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Hosted on AWS with SOC 2 Type II compliance and 99.9% uptime.",
      benefits: [
        "AWS hosting",
  ...
  const benefits = [
    "Your documents are never shared or sold",
        ...
        <div className="mt-24">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We provide comprehensive security benefits to protect your data.
            </p>
          </div>
