...
export const UsageChart = ({
  ...
  const daysRemaining = cycleEnd
    ? Math.ceil(
        (new Date(cycleEnd).getTime() - Date.now()) / (1000 * 60 * 60 * 24),
      )
    : 0;
      ...
      <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex flex-col items-end">
              ...
              <span className="text-[10px] text-gray-400">
                Trend based on total account activity
              </span>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {consumableFeatures.map((feature) => {
              ...
              if (feature === "scans_per_month") {
                ...
                const citeLimit =
                  typeof limits["citation_check"] === "number"
                    ? limits["citation_check"]
                    : 0;
              ...
              return (
                <div key={feature}>
                  <div className="flex justify-between items-center text-sm mb-2">
                    ...
                    <span
                      className={`font-medium ${percentage > 80 ? "text-red-600" : "text-gray-500"}`}>
                    ...
                    <div className="flex items-center gap-4 max-w-2xl">
                      ...
                      <div className="flex-1 h-3 bg-gray-100 rounded-full overflow-hidden relative">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, Math.max(5, (current / 100) * 100))}%`,
                          }}>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 ring-1 ring-gray-50">
          ...
          <div className="space-y-3">
            {(PLAN_FEATURES_LIST[planName] || PLAN_FEATURES_LIST["free"]).map(
              (feature, index) => (
                <div
                  key={index}
