    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-white">
        <DialogHeader>
          ...
          <DialogDescription>
            This style will be used for all citations in your document. The
            Citation Audit will flag any format violations.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="bg-blue-50 rounded-md p-3 text-xs text-blue-700 mb-4">
          You can change this later in settings, but it may require re-checking
          all citations.
        </div>
