...
interface CitationStyleFloatingPanelProps {
    isOpen: boolean;
...
export const CitationStyleFloatingPanel: React.FC<CitationStyleFloatingPanelProps> = ({
    isOpen,
    onConfirm,
    onClose,
    isSaving = false,
    ...
    if (showCustomEditor) {
        return (
            <div className="fixed left-[280px] top-20 w-80 bg-white border-2 border-purple-200 rounded-lg shadow-2xl z-50 p-4 space-y-3">
                {/* Header */}
    ...
    return (
        <div className="fixed left-[280px] top-20 w-80 bg-white border-2 border-blue-200 rounded-lg shadow-2xl z-50 p-4">
            {/* Header */}
