...
export const SourcesLibraryPanel: React.FC<SourcesLibraryPanelProps> = ({
    ...
    const [localCitations, setLocalCitations] = useState<StoredCitation[]>(citations); // Added for live sync
        ...
        <>
            ...
            <div className="flex flex-col h-full bg-white relative">
                ...
                <div className="flex-1 overflow-y-auto px-5 pb-5">
                    {activeTab === "matrix" ? (
                        <LiteratureMatrix sources={localCitations as any} />
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-4 pt-2 border-t border-gray-50">
                                            ...
                                            {(() => {
                                                ...
                                                const isPdf = url.toLowerCase().endsWith(".pdf") || url.startsWith("blob:");
                ...
                {viewerSource && (
                    <PDFAnnotator
                        ...
                        fileUrl={(() => {
                            ...
                            if (!url) return "";
                            if (url.startsWith("blob:") || url.includes(window.location.hostname)) return url;
