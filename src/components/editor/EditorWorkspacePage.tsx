  ...
  return (
    <div
              ...
              <div className="flex-1 overflow-hidden flex flex-col bg-white">
                {visualMapMode === "full" ? (
                  <div className="flex-1 flex flex-col items-center justify-center p-6 text-center text-gray-500 bg-gray-50 h-[calc(100vh-60px)]">
                    ...
                    <p className="text-sm">
                      Close the full screen view to interact with the map here.
                    </p>
                    <button
      ...
      <div className="flex-1 h-full overflow-hidden min-w-0">
        ...
        <div
          className={`h-full w-full ${selectedAuditReport || selectedLibrarySource || (activeLeftPanel === "sources" && activeSourceTab === "matrix") || activeLeftPanel === "visual-map" || isEditorLoading ? "hidden" : "block"}`}>
          {selectedProject && (
            <DocumentEditor
                ...
                <div className="flex-1 h-full relative">
                  <div className="h-full w-full flex items-center justify-center bg-gray-50">
                    <p className="text-gray-400">
                      Editor is active in Full View mode. Switch back to
                      synchronize.
                    </p>
                  </div>
                </div>
