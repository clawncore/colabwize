          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex flex-col items-end gap-1 shrink-0 pt-0.5">
              {worldCitationCount !== undefined && (
                <Badge
                  variant="outline"
                  className="px-1 py-0 text-[8px] text-green-600 bg-green-50/50 border-green-100 shadow-none font-bold">
                  {worldCitationCount}
                </Badge>
              )}
              <Badge
                variant="secondary"
                className="px-1 py-0 text-[8px] bg-slate-50 text-slate-500 border-slate-200 flex items-center gap-1 font-black uppercase tracking-widest shrink-0">
