          ...
          <div className="mb-6 p-4 bg-gray-50  rounded-lg border border-gray-200 ">
            <div className="flex items-center justify-between">
              ...
              <select
                ...
                className="px-3 py-1 border border-gray-300  rounded-lg bg-white  text-gray-900  focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
                ...
                <div
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="px-3 py-1.5 text-sm font-medium text-blue-600  hover:text-blue-800  bg-blue-50  hover:bg-blue-100  rounded-lg transition-colors">
                      Restore
                    </button>
                    <button
                      onClick={() => permanentlyDeleteItem(item.id)}
                      className="px-3 py-1.5 text-sm font-medium text-red-600  hover:text-red-800  bg-red-50  hover:bg-red-100  rounded-lg transition-colors">
                      Delete
                    </button>
                  </div>
                </div>
