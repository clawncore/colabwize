...
export const TwoFactorSetup: React.FC<TwoFactorSetupProps> = ({
  ...
  const [step, setStep] = useState<"intro" | "download" | "qr" | "backup">(
    "intro",
  );
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <CardDescription className="text-green-800 font-medium">
                Active & Protecting your account
              </CardDescription>
            </div>
          </div>
        </CardHeader>
            ...
            <DialogContent className="sm:max-w-[425px] bg-white border-gray-200 text-gray-900 shadow-xl">
              <DialogHeader>
                ...
                <DialogDescription className="text-gray-500">
                  Enter the code from your authenticator app or a backup code to
                  confirm.
                </DialogDescription>
              </DialogHeader>
            ...
            <motion.div
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                      <span className="text-gray-600 text-sm">
                        Required for strict security zones
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
              ...
              <div className="flex justify-end pt-4 border-t border-gray-100">
                <Button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 px-8 py-6 text-base shadow-lg hover:shadow-xl transition-all rounded-xl group">
                  Start Setup{" "}
            ...
            <motion.div
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-gray-500">
                  Scan the QR code with your phone camera to download Google
                  Authenticator.
                </p>
              </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-gray-100">
                ...
                <Button
                  ...
                  disabled={loading}
                  className="bg-blue-600 hover:bg-blue-700 px-8 py-2 rounded-xl text-base h-12 shadow-md hover:shadow-lg">
                  {loading ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      Open Authenticator and scan this unique code.
                    </p>
                  </div>
                ...
                <div className="space-y-6 lg:border-l lg:border-gray-100 lg:pl-12">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      Enter the 6-digit code displayed in your app to activate.
                    </p>
                  </div>
            ...
            <motion.div
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600">
                  Your account is now more secure. When you sign in, you'll be
              ...
              <div className="bg-amber-50 border border-amber-100 rounded-2xl p-6 text-left shadow-sm">
                ...
                <div className="space-y-3 text-amber-900 text-sm leading-relaxed">
                  <p>
                    <strong>Copy and Save:</strong> These codes are the{" "}
                    <strong>ONLY</strong> way to access your account if you lose
                    your phone.
                  </p>
                  <p>
                    <strong>Best Practice:</strong> Store them in a secure
                    password manager or print them out and keep them in a safe
                    place.
                  </p>
                  <p>
                    <strong>Warning:</strong> If you lose your device and these
                    codes, you may lose access to your account permanently.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 my-6">
                  {backupCodes.map((c, i) => (
                    <div
                      key={i}
                      className="bg-white border border-amber-200 rounded p-2 text-center font-mono text-sm text-gray-700 tracking-wider font-bold select-all">
                      {c}
                    </div>
                  ))}
                </div>
