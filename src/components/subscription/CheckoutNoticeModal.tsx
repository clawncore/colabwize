...
export function CheckoutNoticeModal({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
}: CheckoutNoticeModalProps) {
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="py-4 space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <p>
              Payments are securely processed by <strong>Lemon Squeezy</strong>.
            </p>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <p>
              ColabWize <strong>does not</strong> store or see your credit card
              details.
            </p>
          </div>
          ...
          <div className="flex gap-2">
            <ShieldCheck className="h-4 w-4 text-gray-500 flex-shrink-0 mt-0.5" />
            <p>
              Subscriptions are <strong>non-refundable</strong> due to immediate
              access.
            </p>
          </div>
        </div>
