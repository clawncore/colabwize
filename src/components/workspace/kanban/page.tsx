...
export function KanbanBoard() {
  ...
  useEffect(() => {
    ...
    if (currentView && ["kanban", "list", "calendar"].includes(currentView)) {
      setBoardView(currentView as any);
    }
  }, [searchParams]);

  const handleSetBoardView = (view: "kanban" | "list" | "calendar") => {
    setBoardView(view);
  ...
  const loadProjects = async () => {
    try {
      const workspace = await apiClient.get(`/api/workspaces/${workspaceId}`);
  ...
  const shortcuts: ShortcutHandler[] = [
    ...
    {
      key: "b",
      handler: () => handleSetBoardView("kanban"),
      description: "Switch to board view",
      category: "Views",
    },
    {
      key: "l",
      handler: () => handleSetBoardView("list"),
      description: "Switch to list view",
      category: "Views",
    },
    {
      key: "c",
      handler: () => handleSetBoardView("calendar"),
