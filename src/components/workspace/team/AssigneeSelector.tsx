      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            aria-expanded={open}
            disabled={disabled}
            className="w-full justify-between h-9 text-xs border-input bg-white text-foreground hover:bg-muted">
        ...
        <PopoverContent
          className="w-[300px] p-0 bg-white border-border text-popover-foreground"
          align="start">
          <Command>
            <CommandInput
