...
export default function ListMessages({ workspaceId }: { workspaceId?: string }) {
      ...
      .on(
        ...
        async (payload) => {
          if (!optimisticIds.includes(payload.new.id)) {
            ...
            if (workspaceId && payload.new.workspace_id !== workspaceId) {
              return;
            }
    ...
    <>
      <div
        ...
        <div className="flex-1 pb-5 ">
          <LoadMoreMessages workspaceId={workspaceId} />
        </div>
