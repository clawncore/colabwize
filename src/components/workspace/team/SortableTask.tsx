...
export function SortableTask({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`group bg-card p-3 rounded-xl border transition-all cursor-default relative ${isSelected
        ...
        <div className="flex flex-col items-center gap-2 mt-1">
          ...
          <div
            ...
            className={`w-4 h-4 rounded border flex items-center justify-center transition-all cursor-pointer ${isSelected
              ...
              : "bg-white border-input group-hover:border-teal-400 dark:group-hover:border-teal-600"
              }`}
          >
