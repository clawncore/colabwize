      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-semibold px-8 py-6"
              asChild>
...
function FeaturesPresentationFlow() {
  ...
  const additionalFeatures = [
    ...
    },
    {
      icon: Clock,
      title: "24/7 Access",
      description: "Scan anytime, anywhere",
    },
    {
      icon: Bot,
      title: "Safe AI Integrity Assistant",
      description:
        "Provide instant answers to anxiety-inducing questions without risking academic integrity",
    },
  ];
        ...
        <div className="mt-24">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Beyond our core features, we offer additional tools to enhance
      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Ready to Transform Anxiety into Confidence?
          </h2>
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            Join thousands of students and researchers who trust ColabWize
          </p>
