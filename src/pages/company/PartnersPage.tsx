      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
            Grow Together and Make an Impact. Join our partner program and help
            us bring academic integrity tools to students and researchers
            worldwide.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              asChild>
              <RouterLink to="/company/about">Learn More</RouterLink>
            </Button>
          </div>
        </div>
      </div>
  ...
  const features = [
    {
      ...
      description:
        "Partner with us to provide ColabWize to your entire institution at special rates.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Become a ColabWize reseller and earn commissions on every sale.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Build integrations with ColabWize and reach our growing user base.",
      benefits: [
        "Access to our API",
        "Reach our user base",
        "Technical support",
    ...
    },
    {
      ...
      description:
        "Earn 20% recurring commission by referring users to ColabWize.",
      benefits: [
    ...
    },
    {
      icon: Globe,
      title: "Global Reach",
      description: "Partner with us to bring ColabWize to students worldwide.",
      benefits: [
    ...
    },
    {
      icon: Zap,
      title: "Co-Marketing",
      description: "Collaborate on marketing campaigns and grow together.",
      benefits: [
        ...
        <div className="mt-24">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We offer comprehensive benefits to our valued partners.
            </p>
          </div>
      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            Join our partner program and help us bring academic integrity tools
