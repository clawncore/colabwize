      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
            Last updated: January 2026. By accessing and using ColabWize, you
            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <section>
                ...
                <p className="text-gray-600">
                  By accessing and using ColabWize, you accept and agree to be
              ...
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  Permission is granted to temporarily use ColabWize for
              ...
              <section>
                ...
                <p className="text-gray-600">
                  ...
                  ColabWize makes no warranties, expressed or implied, and
              ...
              <section>
                ...
                <p className="text-gray-600">
                  ...
                  of the use or inability to use ColabWize.
                </p>
              </section>
      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            We're committed to providing clear and fair terms of service.
          </p>
