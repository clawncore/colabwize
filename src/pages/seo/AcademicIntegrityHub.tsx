  ...
  const sections = [
    {
      ...
      description:
        "Learn how to maintain a verifiable trail of your writing process to defend against AI accusations.",
      icon: History,
    ...
    },
    {
      ...
      description:
        "Stop 'hallucinated' citations. Ensure every claim in your research is backed by a real, credible source.",
      icon: SearchCheck,
    ...
    },
    {
      ...
      description:
        "How to work with peers while maintaining individual contribution logs for full transparency.",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Why AI detectors fail and how students can protect themselves with academic defensibility.",
      icon: AlertTriangle,
  ...
  const definitions = [
    {
      ...
      description:
        "The ethical policy of academia to maintain honest and responsible research standards.",
    },
    {
      title: "What is Authorship Verification?",
      link: "/what-is-authorship-verification",
      description:
        "The process of proving that a specific piece of text was indeed created by the stated author.",
    },
    {
      title: "What is Citation Auditing?",
      link: "/what-is-citation-verification",
      description:
        "Checking every reference in a document to ensure it accurately supports the claims made.",
    },
  ];
        ...
        <div className="bg-slate-50 border-b border-gray-100 py-16">
          <div className="container-custom max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Equipping students and researchers with the tools and knowledge to
              prove the authenticity, originality, and credibility of their work
              in the age of AI.
            </p>
          </div>
        </div>
          ...
          <div className="container-custom max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        AI detectors are unreliable. Having a verifiable log of
                        your writing process is the only way to prove your voice
                        is your own.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Citations aren't just about formatting. It's about
                        knowing your sources exist and accurately support your
                        research.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        When working with teams, clear contribution tracking
                        protects everyone's academic reputation.
                      </p>
                    </div>
                  </div>
                </div>
                <Button
                  asChild
                  className="mt-10 bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-6 h-auto">
                ...
                <div className="bg-white p-8 rounded-3xl shadow-2xl border border-gray-100 flex flex-col gap-6">
                  ...
                  {definitions.map((def, i) => (
                    <Link key={i} to={def.link} className="block group">
                      <h4 className="text-blue-600 font-bold mb-1 group-hover:underline">
                        {def.title}
                      </h4>
                  ...
                  <Link
                    ...
                    className="bg-gray-50 p-4 rounded-2xl flex items-center justify-between group">
        ...
        <section className="py-24 container-custom max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              Specific guides for the most common challenges in modern academic
              writing.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-white border border-gray-100 shadow-sm flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 text-sm mb-6">
                A step-by-step guide on creating an evidence trail for your
                writing process.
              </p>
              <Button
                variant="link"
                asChild
                className="mt-auto text-blue-600 font-bold p-0">
            ...
            <div className="p-8 rounded-3xl bg-white border border-gray-100 shadow-sm flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 text-sm mb-6">
                Techniques for verifying research papers and avoiding
            ...
            <div className="p-8 rounded-3xl bg-white border border-gray-100 shadow-sm flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 text-sm mb-6">
                Working ethically on shared research without compromising
              ...
              <Button
                ...
                asChild
                className="mt-auto text-blue-600 font-bold p-0">
                <Link to="/how-to-collaborate-on-academic-papers">
                  Learn More
                </Link>
              </Button>
            </div>
        ...
        <section className="py-20 bg-blue-600 overflow-hidden relative">
          ...
          <div className="container-custom max-w-4xl mx-auto text-center relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Accused of using AI? Here's what to do.
            </h2>
            <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto">
              Read our deep dive into why false AI detection happens and how
              universities are evolving their policies.
            </p>
            <Button
              asChild
              className="bg-white text-blue-600 hover:bg-blue-50 font-extrabold px-10 py-4 h-auto rounded-full">
              <Link to="/false-ai-detection-in-academia">
