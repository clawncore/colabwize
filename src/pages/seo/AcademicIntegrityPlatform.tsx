...
const AcademicIntegrityPlatform = () => {
  const pillars = [
    ...
    },
    {
      ...
      description:
        "A continuous, passive log of your writing workflow that creates an immutable record of your work.",
      icon: Clock,
    ...
    },
    {
      ...
      description:
        "Real-time co-authoring with individual contribution tracking and team-based integrity checks.",
      icon: FileText,
          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-2xl">
                ColabWize is the first integrity-first workspace built
                specifically for the challenges of modern academia. We help you
                produce work that is transparent, credible, and defensible.
              </p>
          ...
          <div className="container-custom">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                A Multi-Layered Integrity Approach
              </h2>
              <p className="text-gray-500 max-w-xl mx-auto">
                Building academic trust requires more than just a scan. It
                requires a continuous record of effort and evidence.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {pillars.map((pillar, idx) => (
                <div
                  key={idx}
                  className="group p-10 bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300">
                  <div className="flex justify-between items-start mb-8">
                    ...
                    <span className="text-[10px] uppercase font-bold tracking-widest text-blue-500 bg-blue-50 px-2 py-1 rounded-md">
                      {pillar.badge}
                    </span>
                  </div>
          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl md:text-5xl font-bold mb-8">
                Ready to prove your credibility?
              </h2>
              <p className="text-gray-400 text-xl mb-12">
                Join the academic community using ColabWize to defend their work
                and streamline their research.
              </p>
              <Button
