          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                Chicago Style <span className="text-red-600">Generator</span>{" "}
                (17th Edition)
              </h1>
              <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                Support for both Notes/Bibliography and Author/Date systems. The
                only tool that guarantees professional-grade Chicago formatting.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="bg-red-600 hover:bg-red-700 text-white h-14 px-8 text-lg font-semibold rounded-xl shadow-lg shadow-red-200 transition-all">
        ...
        <section className="py-24">
          <div className="container-custom max-w-4xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-8">
              Professional Citation for History & Social Science
            </h2>
            <div className="prose prose-lg prose-slate max-w-none mb-16">
              <p>
                Chicago style is often considered the most complex citation
                system due to its extensive use of footnotes and specific
                punctuation rules. It remains the gold standard for historical
                research and many academic publications.
              </p>
              <p>
                ColabWize removes the headache from Chicago style. Our tool
                automatically creates the shortened note versions and provides
                the correct bibliographic formatting for every source type
                imaginable—from ancient manuscripts to modern podcasts.
              </p>
            </div>
            ...
            <div className="bg-slate-900 rounded-3xl p-12 text-white text-center relative overflow-hidden">
              ...
              <p className="text-red-100/80 text-lg mb-8 max-w-xl mx-auto">
                Advanced features for advanced scholars. Start your project on a
                solid foundation.
              </p>
