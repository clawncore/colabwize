          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                Academic <span className="text-indigo-600">Plagiarism</span>{" "}
                Checker
              </h1>
              <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                Don't just check for matches—prove your originality. ColabWize
                combines plagiarism detection with authorship verification to
                give you a complete defensibility report.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="bg-indigo-600 hover:bg-indigo-700 text-white h-14 px-8 text-lg font-semibold rounded-xl shadow-lg shadow-indigo-200 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-8 border border-slate-100 rounded-3xl hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-50 transition-all group">
                ...
                <p className="text-sm text-slate-600">
                  Scans billions of websites, journals, and private
                  repositories.
                </p>
              </div>
              <div className="p-8 border border-slate-100 rounded-3xl hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-50 transition-all group">
                ...
                <p className="text-sm text-slate-600">
                  Industry-leading detection for ChatGPT, Claude, and Gemini
                  content.
                </p>
              </div>
              <div className="p-8 border border-slate-100 rounded-3xl hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-50 transition-all group">
                ...
                <p className="text-sm text-slate-600">
                  Get direct links to matching sources for easy correction.
                </p>
              </div>
              <div className="p-8 border border-slate-100 rounded-3xl hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-50 transition-all group">
                ...
                <p className="text-sm text-slate-600">
                  Your documents are never stored in public databases or resold.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 bg-slate-50">
          <div className="container-custom max-w-4xl text-center">
            <h2 className="text-3xl font-bold text-slate-900 mb-8">
              Academic Success Depends on Originality
            </h2>
            <div className="prose prose-lg prose-slate max-w-none mb-16 mx-auto">
              <p>
                In an era where AI can generate content in seconds, proving that
                your work is original has never been more important. ColabWize
                doesn't just look for matches—it provides the evidence you need
                to show that the thinking and writing behind your paper are
                yours.
              </p>
            </div>
            <Button className="bg-slate-900 text-white hover:bg-slate-800 h-14 px-12 text-lg font-bold rounded-xl transition-all shadow-xl">
